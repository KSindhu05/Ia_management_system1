...
// NEW CAEG CIE-2 marks in student registration order
const caegMarks = [
    30, 11, 10, 48, 44, 45, 39, 12, 41, 39,
    8, 22, 44, 23, 37, 37, 42, 39, 49, 42,
    31, 41, 34, 22, 45, 47, 18, 48, 12, 18,
    45, 45, 40, 44, 32, 20, 4, 30, 45, 38,
    10, 43, 36, 36, 48, 33, 21, 21, 30, 44,
    41, 34, 36, 31, 18, 'AB', 'AB', 44, 38, 48,
    24
];

async function updateCAEGCIE2() {
    try {
        console.log('🔄 Starting CAEG CIE-2 Update (NEW DATA)...\n');
        ...
        if (!caegSubject) {
            console.log('❌ CAEG subject not found. Available subjects:');
        ...
        // Delete existing CIE-2 marks for CAEG
        console.log('🗑️ Deleting existing CIE-2 marks for CAEG...');
        ...
        console.log(`- Average marks: ${avgMark.toFixed(2)}/50`);
        console.log(`- Absent students: ${absentCount}`);
        console.log(`- Top scorers (≥45): ${topScorers}\n`);

        console.log('✅ CAEG CIE-2 update completed successfully!');
